...
class HeuristicComparison:
    ...
    def generate_problems(self, num_problems: int, **kwargs) -> List[Tuple]:
        ...
        with ProcessPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            for future in tqdm(as_completed(futures), total=num_problems,
    ...
    def plot_parameter_study(self, results):
        ...
        plot_dir = Path("heuristic_comparison")
        ...
        data_filename = plot_dir / f'{self.domain}_results_{timestamp}.csv'
